    ...
    ***********************************-->
                                            ...
                                            <form id="formunit" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="kode_unit"
                                                        id="exampleFormControlInput1" placeholder="masukkan Kode Unit">
                                                </div>

                                                <div class="form-group">
                                                    <label for="exampleFormControlInput1">Nama Unit</label>
                                                    <input type="text" class="form-control" name="name_unit"
                                                        id="exampleFormControlInput1" placeholder="masukkan nama Unit">
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-dismiss="modal">Close</button>
                                                    <button type="button" class="btn btn-primary" id="btnSaveUnit">Save
                                                        changes</button>
                                                </div>
                                            </form>
                                        </div>
                                                    ...
                                                    <div class="modal fade" id="Edit-{{ $unit->id }}"
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <form class="editformunit" data-id="{{ $unit->id }}"
    ...
    <script>
        $('#btnSaveUnit').on('click', function() {
            let form = document.getElementById('formunit');
            let formData = new FormData(form);


            $.ajax({
                url: "{{ route('Tambah_Unit') }}",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        // edit
        $(document).on('submit', '.editformunit', function(e) {
            e.preventDefault();
        ...
        // delete
        $(document).on('submit', '.form-delete-unit', function(e) {
            e.preventDefault();
